...
def simulate(problem, run_number, max_steps=100, planning_time=0.5, max_time=120, visualize=False, results_folder="results/gridworld_3"):
    """
    ...
    with open(results_file, 'w', newline='') as file:
        ...
        grid_size, evader_pose, pursuer_pose, target_pose, obstacles = load_environment_from_csv('env/gridworld_3.csv')
...
if __name__ == '__main__':
    ...
    # Run the simulation 100 times and save results in the gridworld_3 folder
